...
## 3. Почему degradation_sweep теперь правдоподобен

До внедрения адаптивного `.tran` окно анализа было фиксированным (5 мкс). На частотах ниже ~200 кГц в него попадал лишь кусочек периода, и Фурье-анализ давал бессмысленно высокие искажения. С ростом частоты всё больше периодов укладывалось в окно, THD стремился к истинному значению — создавалась иллюзия, что искажения падают.

Теперь, благодаря динамическому `.tran`, для каждой частоты гарантировано:
...
Как следствие, график THD от частоты показывает **реальный** рост искажений, обусловленный снижением запаса по фазе и глубины обратной связи с повышением частоты. Именно это вы и наблюдаете на своём изображении — монотонное увеличение THD с ~0.048% до ~0.058%, что полностью соответствует ожиданиям для ADA4870.
